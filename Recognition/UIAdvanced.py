...
class Ui_AdvancedWindow(object):
    ...
    def noise_change(self):
        value = self.deNoiseSlider.value()
        if(value == 1):
            self.lb_denoise.setText("Median")
        elif(value == 2):
            self.lb_denoise.setText("Smooth")
        elif(value == 3):
            self.lb_denoise.setText("Blur")
    ...
    def edge_run(self, i):
        val = i
        noiseVal = self.deNoiseSlider.value()
    ...
    def setupUi(self, AdvancedWindow, path):
        ...
        self.deNoiseSlider.setProperty("value", 3)
        ...
        self.boundingSlider.setMaximum(100)
        ...
        self.lb_denoise.setGeometry(QtCore.QRect(80, 30, 40, 16))
    ...
    def retranslateUi(self, AdvancedWindow):
        ...
        self.lb_denoise.setText(_translate("AdvancedWindow", "Blur"))
