...
class Ui_MainWindow(object):
    ...
    def network(self):
        string = recognition.recognition.recognize()
        self.textPreview.setText(string)
    def convert(self):
        main.main.start_convert(1, 100, fname, 10, 10, 3)
    ...
    def setupUi(self, MainWindow):
        ...
        self.btn_save.clicked.connect(self.network)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_convert.setText(_translate("MainWindow", "Process"))
        self.btn_save.setText(_translate("MainWindow", "Convert"))
